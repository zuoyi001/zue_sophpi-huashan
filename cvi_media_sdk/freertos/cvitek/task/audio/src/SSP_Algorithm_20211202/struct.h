...
/* Quadratic Filter */
typedef struct {
    short *qcoef;    /* point to the quad coeff */
...
typedef struct {
    /* Near-end SSP Parameter in MIC Path */
    unsigned short para_client_config;                    /* for choosing client's prototype machine, [0, 4] */
    ...
    /* Near-end SSP Parameter in SPK Path */
