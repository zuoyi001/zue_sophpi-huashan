...
#ifndef __CV182XAADAC_H__
#define __CV182XAADAC_H__
...
#define CV182xa_DAC_VOL_STEP	0x8
#define DAC_VOL_L(V) (V == 0 ? 0 : (V * CV182xa_DAC_VOL_STEP) - 1)
#define DAC_VOL_R(V) ((V == 0 ? 0 : (V * CV182xa_DAC_VOL_STEP) - 1) << 16)
...
struct cv182xaadc {
	...
	struct mutex mutex;
#ifdef CONFIG_PM_SLEEP
	struct cv182xaadc_context *reg_ctx;
#endif
};
...
struct cv182xadac {
	...
	struct mutex mutex;
#ifdef CONFIG_PM_SLEEP
	struct cv182xadac_context *reg_ctx;
#endif
};

extern struct proc_dir_entry *proc_audio_dir;

#endif  /* __CV182XAADAC_H__ */
