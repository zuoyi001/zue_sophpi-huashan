$(function () {
  ...
  $("#osd_btn_save").click(function () {
    ...
    osd_settings['text3_content2'] = document.getElementById("osd_text3_content2").value;
    osd_settings['text3_content3'] = document.getElementById("osd_text3_content3").value;
    ...
    console.log(osd_settings['text3_content2'].length);
    var txt4_len = osd_settings['text3_content2'].length;
    if (txt4_len > 48) {
        alert('string count : ' + txt4_len + ' too long' + ' and Max count is 48');
        func_get_osd_cfg();
        return;
    }
    console.log(osd_settings['text3_content3'].length);
    var txt5_len = osd_settings['text3_content3'].length;
    if (txt5_len > 48) {
        alert('string count : ' + txt5_len + ' too long' + ' and Max count is 48');
        func_get_osd_cfg();
        return;
    }
