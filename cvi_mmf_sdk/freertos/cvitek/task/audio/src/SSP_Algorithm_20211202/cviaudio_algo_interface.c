...
#define  _AUDIO_ALGO_INTERFACE_VERSION_TAG_ "Aud_AlgoInterface_ver20211202"
#define _AUDIO_ALGO_INTERNAL_VERSION_ "CVITEK_AEC_Algo_20211202"
...
void *CviAud_Algo_Init(int s32FunctMask, void *param_info)
{
	...
	ssp_para_info.para_spk_fun_config = 1;
