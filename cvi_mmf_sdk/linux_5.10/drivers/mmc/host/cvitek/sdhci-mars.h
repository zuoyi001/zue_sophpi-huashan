...
#define CVI_MARS_SDHCI_VENDOR_OFFSET		0x200
#define CVI_MARS_SDHCI_VENDOR_MSHC_CTRL_R	(CVI_MARS_SDHCI_VENDOR_OFFSET + 0x0)
#define CVI_MARS_SDHCI_PHY_TX_RX_DLY		(CVI_MARS_SDHCI_VENDOR_OFFSET + 0x40)
#define CVI_MARS_SDHCI_PHY_DS_DLY			(CVI_MARS_SDHCI_VENDOR_OFFSET + 0x44)
#define CVI_MARS_SDHCI_PHY_DLY_STS			(CVI_MARS_SDHCI_VENDOR_OFFSET + 0x48)
#define CVI_MARS_SDHCI_PHY_CONFIG			(CVI_MARS_SDHCI_VENDOR_OFFSET + 0x4C)
