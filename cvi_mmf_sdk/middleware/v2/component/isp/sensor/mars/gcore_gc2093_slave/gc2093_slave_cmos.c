...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	case WDR_MODE_NONE:   /*linear mode*/
		...
		pstAeSnsDft->u32InitExposure = g_au32InitExposure[ViPipe] ?
			g_au32InitExposure[ViPipe] : g_astGc2093_Slave_mode[GC2093_SLAVE_MODE_1920X1080P30].stExp[0].u16Def;
...
static CVI_S32 cmos_inttime_update(VI_PIPE ViPipe, CVI_U32 *u32IntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		if (u16Sexp < 0x4)
			gc2093_slave_write_register(ViPipe, 0x0032, 0xfd);
		else
			gc2093_slave_write_register(ViPipe, 0x0032, 0xf8);
	} else {
