...
enum opt_code
{
  ...
  OPT_mglibc = 1624,                         /* -mglibc */
  OPT_minvariant_as_constant = 1625,         /* -minvariant-as-constant */
  OPT_mipa_unhot_inline = 1626,              /* -mipa-unhot-inline */
  OPT_mipush = 1627,                         /* -mipush */
  OPT_miv_adjust_addr_cost = 1628,           /* -miv-adjust-addr-cost */
  OPT_mldd = 1629,                           /* -mldd */
  OPT_mldi = 1630,                           /* -mldi */
  OPT_mldr = 1631,                           /* -mldr */
  OPT_mmove_loop_vsetvl = 1632,              /* -mmove-loop-vsetvl */
  OPT_mmula = 1633,                          /* -mmula */
  OPT_mmusl = 1634,                          /* -mmusl */
  OPT_mplt = 1635,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1636,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1637,                         /* -mrelax */
  OPT_mrev = 1638,                           /* -mrev */
  OPT_mrevw = 1639,                          /* -mrevw */
  OPT_mriscv_attribute = 1640,               /* -mriscv-attribute */
  OPT_msave_restore = 1641,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1642,               /* -mshorten-memrefs */
  OPT_msignedness_cmpiv = 1643,              /* -msignedness-cmpiv */
  OPT_msmall_data_limit_ = 1644,             /* -msmall-data-limit= */
  OPT_msrri = 1645,                          /* -msrri */
  OPT_msrriw = 1646,                         /* -msrriw */
  OPT_mstrict_align = 1647,                  /* -mstrict-align */
  OPT_mthread_jumps1 = 1648,                 /* -mthread-jumps1 */
  OPT_mtune_ = 1649,                         /* -mtune= */
  OPT_muclibc = 1650,                        /* -muclibc */
  OPT_mvlen_ = 1651,                         /* -mvlen= */
  OPT_mxor_combine = 1652,                   /* -mxor-combine */
  OPT_n = 1653,                              /* -n */
  ...
  OPT_time = 1772,                           /* -time */
  OPT_time_ = 1773,                          /* -time= */
  OPT_traditional = 1774,                    /* -traditional */
  OPT_traditional_cpp = 1775,                /* -traditional-cpp */
  OPT_tree_stats = 1776,                     /* -tree-stats */
  OPT_trigraphs = 1777,                      /* -trigraphs */
  OPT_type_stats = 1778,                     /* -type-stats */
  OPT_u = 1779,                              /* -u */
  OPT_undef = 1780,                          /* -undef */
  OPT_v = 1781,                              /* -v */
  OPT_version = 1782,                        /* -version */
  OPT_w = 1783,                              /* -w */
  OPT_wrapper = 1784,                        /* -wrapper */
  OPT_x = 1785,                              /* -x */
  OPT_z = 1786,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
