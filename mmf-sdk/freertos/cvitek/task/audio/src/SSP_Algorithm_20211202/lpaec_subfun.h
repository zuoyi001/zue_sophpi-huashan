...
not enter
extern inline void DC_filter(const short *in, float radius, float *out, int len, float *mem, short *save_mic_in);
...
#else
/* Function Declarations */
void DC_filter(const short *in, float radius, float *out, int len, float *mem, short *save_mic_in);
