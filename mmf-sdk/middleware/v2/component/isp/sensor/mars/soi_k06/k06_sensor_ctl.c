...
static void k06_linear_1440p25_init(VI_PIPE ViPipe)
{
	...
	k06_write_register(ViPipe, 0x32, 0x1C);
	k06_write_register(ViPipe, 0x33, 0x5C);
	k06_write_register(ViPipe, 0x34, 0x2C);
	k06_write_register(ViPipe, 0x35, 0x2C);
	k06_write_register(ViPipe, 0x3A, 0xB6);
	k06_write_register(ViPipe, 0x56, 0x92);
	k06_write_register(ViPipe, 0x59, 0x28);
	...
	k06_write_register(ViPipe, 0x85, 0x46);
	...
	k06_write_register(ViPipe, 0xA7, 0x80);
