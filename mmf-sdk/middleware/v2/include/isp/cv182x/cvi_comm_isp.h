...
typedef struct _ISP_AE_STATISTICS_CFG_S {
	...
	CVI_U16 u16RGain; /*RW; Range:[0x0, 0x3FFF]*/
	CVI_U16 u16GGain; /*RW; Range:[0x0, 0x3FFF]*/
	CVI_U16 u16BGain; /*RW; Range:[0x0, 0x3FFF]*/
...
typedef struct _ISP_DEMOSAIC_FILTER_AUTO_ATTR_S {
	CVI_U16 DetailWgtThr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
...
typedef struct _ISP_MESH_SHADING_GAIN_LUT_ATTR_S {
	CVI_U8 Size; /*RW; Range:[0x1, 0x7]*/
	CVI_U16 ColorTemperature[ISP_MLSC_COLOR_TEMPERATURE_SIZE]; /*RW; Range:[0x0, 0x7530]*/
...
typedef struct _ISP_FSWDR_MANUAL_ATTR_S {
	...
	CVI_U16 WDRMotionCombineMaxWeight; /*RW; Range:[0x100, 0x100]*/
...
typedef struct _ISP_FSWDR_ATTR_S {
	...
	CVI_BOOL WDRDitherEnable; /*RW; Range:[0, 1]*/
...
typedef struct _ISP_DRC_ATTR_S {
	...
	CVI_BOOL DetailEnhanceEnable; /*R; Range:[0x0, 0x1]*/
...
typedef struct _ISP_TNR_MANUAL_ATTR_S {
	...
	CVI_U8 MtDetectUnit; /*RW; Range:[0x0, 0x6]*/
...
typedef struct _ISP_TNR_AUTO_ATTR_S {
	...
	CVI_U8 MtDetectUnit[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x6]*/
