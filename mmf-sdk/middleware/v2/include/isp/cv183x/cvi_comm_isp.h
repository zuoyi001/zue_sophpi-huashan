...
typedef struct _ISP_AE_STATISTICS_CFG_S {
	...
	CVI_U8 u8StatisticsShiftBits; /*RW; Range:[0x0, 0x7]*/
	CVI_U16 u16RGain; /*RW; Range:[0x0, 0x3FF]*/
	CVI_U16 u16GGain; /*RW; Range:[0x0, 0x3FF]*/
	CVI_U16 u16BGain; /*RW; Range:[0x0, 0x3FF]*/
...
typedef struct _ISP_AE_ROUTE_NODE_S {
	...
	CVI_U32 u32SysGain; /*RW; Range:[0x0, 0x7FFFFFFF]*/
	ISP_IRIS_F_NO_E enIrisFNO; /*RW; Range:[0x0, 0xA]*/
	CVI_U32 u32IrisFNOLin; /*RW; Range:[0x0, 0xA]*/
} ISP_AE_ROUTE_NODE_S;
...
typedef struct _ISP_WDR_EXPOSURE_ATTR_S {
	...
	CVI_U32 u32DiffPixelNum; /*RW; Range:[0x0, 0xFF]*/
	CVI_U16 u16LELowBinThr; /*RW; Range:[0x0, 0xFF]*/
...
typedef struct _ISP_AF_CROP_S {
	...
	CVI_U16 u16H; /*RW; Range:[0x110, 0xFFF]*/
} ISP_AF_CROP_S;
...
typedef struct _ISP_AWB_LUM_HISTGRAM_ATTR_S {
	...
	CVI_U16 au16HistWt[AWB_LUM_HIST_NUM]; /*RW; Range:[0x0, 0xFF]*/
...
typedef struct _ISP_AWB_ATTR_S {
	...
	CVI_U16 u16RefColorTemp; /*RW; Range:[0x1, 0xFFFF]*/
	CVI_U16 au16StaticWB[ISP_BAYER_CHN_NUM]; /*RW; Range:[0x1, 0xFFFF] G/R*/
...
typedef struct _ISP_WB_ATTR_S {
	CVI_BOOL bByPass;
	CVI_U8 u8AWBRunInterval; /*RW; Range:[0x1, 0x3FFF]*/
	ISP_OP_TYPE_E enOpType;
...
typedef struct _ISP_DCF_CONST_INFO_S {
	CVI_U8 au8ImageDescription[DCF_DRSCRIPTION_LENGTH];
	CVI_U8 au8Make[DCF_DRSCRIPTION_LENGTH];
	CVI_U8 au8Model[DCF_DRSCRIPTION_LENGTH];
	CVI_U8 au8Software[DCF_DRSCRIPTION_LENGTH];

	CVI_U8 u8LightSource;
	CVI_U32 u32FocalLength;
	CVI_U8 u8SceneType;
	CVI_U8 u8CustomRendered;
	CVI_U8 u8FocalLengthIn35mmFilm;
...
typedef struct _ISP_DCF_UPDATE_INFO_S {
	CVI_U32 u32ISOSpeedRatings;
	CVI_U32 u32ExposureTime;
	CVI_U32 u32ExposureBiasValue;
	CVI_U8 u8ExposureProgram;
	CVI_U32 u32FNumber;
	CVI_U32 u32MaxApertureValue;
...
typedef struct _ISP_NR_FILTER_MANUAL_ATTR_S {
	CVI_U8 NrLscRatio; /*RW; Range:[0x0, 0x1f]*/
	CVI_U8 LumaStr[8]; /*RW; Range:[0x0, 0x1f]*/
	CVI_U16 VarThr; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 CoringWgtLF; /*RW; Range:[0x0, 0x100]*/
	CVI_U16 CoringWgtHF; /*RW; Range:[0x0, 0x100]*/
	CVI_U8 NonDirFiltStr; /*RW; Range:[0x0, 0x1f]*/
	CVI_U8 VhDirFiltStr; /*RW; Range:[0x0, 0x1f]*/
...
typedef struct _ISP_NR_FILTER_AUTO_ATTR_S {
	CVI_U8 NrLscRatio[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x1f]*/
	CVI_U8 LumaStr[8][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x1f]*/
	CVI_U16 VarThr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 CoringWgtLF[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x100]*/
	CVI_U16 CoringWgtHF[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x100]*/
	CVI_U8 NonDirFiltStr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x1f]*/
	CVI_U8 VhDirFiltStr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x1f]*/
...
typedef struct _ISP_DPC_AUTO_ATTR_S {
	CVI_BOOL dpc_enable[ISP_AUTO_ISO_STRENGTH_NUM];
	CVI_BOOL dpc_staticdpc_enable[ISP_AUTO_ISO_STRENGTH_NUM];
...
typedef struct _ISP_SHARPEN_MANUAL_ATTR_S {
	CVI_U16 EdgeGain; /*RW; Range:[0x0, 0x3f]*/
	CVI_U16 TextureGain; /*RW; Range:[0x0, 0x3ff]*/
...
typedef struct _ISP_SHARPEN_AUTO_ATTR_S {
	CVI_U16 EdgeGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3f]*/
	CVI_U16 TextureGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
	...
	CVI_U8 DeltaShtCtrlUnit[ISP_AUTO_ISO_STRENGTH_NUM];
	...
	CVI_U8 OverShootGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 UnderShootGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
...
typedef struct _ISP_SHARPEN_ATTR_S {
	...
	CVI_BOOL FilterCoefByISOFuncEn;
	...
	CVI_U8 EdgeThr; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 TextureThr; /*RW; Range:[0x0, 0xff]*/
...
typedef struct _ISP_TNR_MANUAL_ATTR_S {
	CVI_U8 MergeMode; /*RW; Range:[0x0, 0x1]*/
	CVI_U8 MergeModeAlpha; /*RW; Range:[0x0, 0x1]*/
	CVI_U8 TnrStrength0; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MapThdLow0; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MapThdHigh0; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 TnrStrength1; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MapThdLow1; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MapThdHigh1; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MtDetectUnit; /*RW; Range:[0, 6]*/
	CVI_S16 BrightnessNoiseLevelLE; /*RW; Range:[1, 1023]*/
	CVI_S16 BrightnessNoiseLevelSE; /*RW; Range:[1, 1023]*/
} ISP_TNR_MANUAL_ATTR_S;

typedef struct _ISP_TNR_AUTO_ATTR_S {
	CVI_U8 MergeMode[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x1]*/
	CVI_U8 MergeModeAlpha[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x1]*/
	...
	CVI_U8 TnrStrength1[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MapThdLow1[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MapThdHigh1[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MtDetectUnit[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0, 6]*/
	CVI_S16 BrightnessNoiseLevelLE[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[1, 1023]*/
	CVI_S16 BrightnessNoiseLevelSE[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[1, 1023]*/
} ISP_TNR_AUTO_ATTR_S;
...
typedef struct _ISP_TNR_GHOST_MANUAL_ATTR_S {
	...
	CVI_U8 PrvMotion1[4]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 PrtctWgt1[4]; /*RW; Range:[0x0, 0xf]*/
...
typedef struct _ISP_TNR_GHOST_AUTO_ATTR_S {
	...
	CVI_U8 PrvMotion1[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 PrtctWgt1[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xf]*/
...
typedef struct _ISP_TNR_MT_PRT_MANUAL_ATTR_S {
	CVI_U8 LowMtPrtLevel; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 LowMtPrtIn[4]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 LowMtPrtOut[4]; /*RW; Range:[0x0, 0xff]*/
	CVI_S16 LowMtPrtSlope0[3]; /*RW; Range:[-2048, 2047]*/
} ISP_TNR_MT_PRT_MANUAL_ATTR_S;

typedef struct _ISP_TNR_MT_PRT_AUTO_ATTR_S {
	CVI_U8 LowMtPrtLevel[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 LowMtPrtIn[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 LowMtPrtOut[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_S16 LowMtPrtSlope0[3][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[-2048, 2047]*/
...
typedef struct _ISP_DCI_MANUAL_ATTR_S {
	...
	CVI_U16 BlcCtrl; /*RW; Range:[0x0, 0x7fff]*/
	CVI_U16 WhtCtrl; /*RW; Range:[0x0, 0x7fff]*/
...
typedef struct _ISP_DCI_AUTO_ATTR_S {
	...
	CVI_U16 BlcCtrl[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x7fff]*/
	CVI_U16 WhtCtrl[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x7fff]*/
...
typedef struct _ISP_RADIAL_SHADING_ATTR_S {
	CVI_BOOL Enable;
	CVI_U8 UpdateInterval; /*RW; Range:[0x1, 0xFF]*/
	CVI_U16 CenterX; /*RW; Range:[0x0, 0xfff]*/
	CVI_U16 CenterY; /*RW; Range:[0x0, 0x7ff]*/
} ISP_RADIAL_SHADING_ATTR_S;

typedef struct _ISP_RADIAL_SHADING_GAIN_LUT_ATTR_S {
	CVI_U16 RLscGainLut[ISP_RLSC_COLOR_TEMPERATURE_SIZE][ISP_RLSC_WINDOW_SIZE]; /*RW; Range:[0x0, 0xfff]*/
...
typedef struct _ISP_DEMOSAIC_FILTER_AUTO_ATTR_S {
	...
	CVI_U16 LumaWgtThr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
...
#define DEMOSAIC_CORING_NUM 33
#define DEMOSAIC_GAIN_NUM 33
typedef struct _ISP_DEMOSAIC_EE_MANUAL_ATTR_S {
	CVI_U16 OverShtGain; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 UnderShtGain; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U8 HFGainTable[DEMOSAIC_GAIN_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 GainTable[DEMOSAIC_GAIN_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 LumaTunedCoring[DEMOSAIC_CORING_NUM]; /*RW; Range:[0x0, 0xfff]*/
	CVI_U8 NoiseSuppressStr; /*RW; Range:[0x0, 0xff]*/
} ISP_DEMOSAIC_EE_MANUAL_ATTR_S;

typedef struct _ISP_DEMOSAIC_EE_AUTO_ATTR_S {
	CVI_U16 OverShtGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 UnderShtGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U8 HFGainTable[DEMOSAIC_GAIN_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 GainTable[DEMOSAIC_GAIN_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 LumaTunedCoring[DEMOSAIC_CORING_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xfff]*/
	CVI_U8 NoiseSuppressStr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
...
typedef struct _ISP_CCM_AUTO_ATTR_S {
	CVI_BOOL ISOActEnable;
	CVI_BOOL TempActEnable;
	CVI_U8 CCMTabNum; /*RW; Range:[0x3, 0x7]*/
	ISP_COLORMATRIX_ATTR_S CCMTab[7]; /*RW; Range:[0x0, 0x0]*/
} ISP_CCM_AUTO_ATTR_S;
...
//  HSV
//-----------------------------------------------------------------------------
#define ISP_HSV_CTRL_POINT_NUM			(24)
#define ISP_HSV_COLOR_TEMPERATURE_SIZE	(7)

typedef struct _ISP_HSV_HBYH_MANUAL_ATTR_S {
	CVI_S8 CtrlPointsOffset[ISP_HSV_CTRL_POINT_NUM]; /*RW; Range:[-64, 64]*/
} ISP_HSV_HBYH_MANUAL_ATTR_S;

typedef struct _ISP_HSV_HBYH_AUTO_ATTR_S {
	CVI_U8 HLUTTabNum; /*RW; Range:[3, 7]*/
	CVI_U16 ColorTemp[ISP_HSV_COLOR_TEMPERATURE_SIZE]; /*RW; Range:[500, 30000]*/
	CVI_S8 CtrlPointsOffset[ISP_HSV_COLOR_TEMPERATURE_SIZE][ISP_HSV_CTRL_POINT_NUM]; /*RW; Range:[-64, 64]*/
} ISP_HSV_HBYH_AUTO_ATTR_S;

typedef struct _ISP_HSV_HBYH_ATTR_S {
	CVI_BOOL Enable;
	ISP_OP_TYPE_E enOpType;
	ISP_HSV_HBYH_MANUAL_ATTR_S stManual;
	ISP_HSV_HBYH_AUTO_ATTR_S stAuto;
} ISP_HSV_HBYH_ATTR_S;

typedef struct _ISP_HSV_SBYS_MANUAL_ATTR_S {
	CVI_U16 SatCoringLinearTh; /*RW; Range:[0, 512]*/
	CVI_U16 SatCoringLinearLmt; /*RW; Range:[0, 12286]*/
} ISP_HSV_SBYS_MANUAL_ATTR_S;

typedef struct _ISP_HSV_SBYS_AUTO_ATTR_S {
	CVI_U16 SatCoringLinearTh[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0, 512]*/
	CVI_U16 SatCoringLinearLmt[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0, 12286]*/
} ISP_HSV_SBYS_AUTO_ATTR_S;

typedef struct _ISP_HSV_SBYS_ATTR_S {
	CVI_BOOL Enable;
	ISP_OP_TYPE_E enOpType;
	ISP_HSV_SBYS_MANUAL_ATTR_S stManual;
	ISP_HSV_SBYS_AUTO_ATTR_S stAuto;
} ISP_HSV_SBYS_ATTR_S;

typedef struct _ISP_HSV_SBYH_MANUAL_ATTR_S {
	CVI_S16 CtrlPointsOffset[ISP_HSV_CTRL_POINT_NUM]; /*RW; Range:[-64, 128]*/
} ISP_HSV_SBYH_MANUAL_ATTR_S;

typedef struct _ISP_HSV_SBYH_AUTO_ATTR_S {
	CVI_U8 HLUTTabNum; /*RW; Range:[3, 7]*/
	CVI_U16 ColorTemp[ISP_HSV_COLOR_TEMPERATURE_SIZE]; /*RW; Range:[500, 30000]*/
	CVI_S16 CtrlPointsOffset[ISP_HSV_COLOR_TEMPERATURE_SIZE][ISP_HSV_CTRL_POINT_NUM]; /*RW; Range:[-64, 128]*/
} ISP_HSV_SBYH_AUTO_ATTR_S;

typedef struct _ISP_HSV_SBYH_ATTR_S {
	CVI_BOOL Enable;
	ISP_OP_TYPE_E enOpType;
	ISP_HSV_SBYH_MANUAL_ATTR_S stManual;
	ISP_HSV_SBYH_AUTO_ATTR_S stAuto;
} ISP_HSV_SBYH_ATTR_S;

typedef struct _ISP_HSV_ATTR_S {
	CVI_U8 UpdateInterval; /*RW; Range:[0x1, 0xFF]*/
	ISP_HSV_HBYH_ATTR_S stHbyHAttr;
	ISP_HSV_SBYS_ATTR_S stSbySAttr;
	ISP_HSV_SBYH_ATTR_S stSbyHAttr;
} ISP_HSV_ATTR_S;
...
typedef struct _ISP_FSWDR_MANUAL_ATTR_S {
	...
	CVI_U8 WDRCombineMinWeight; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 WDRCombineMaxWeight; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 WDRCombineSNRAwareToleranceLevel; /*RW; Range:[0x0, 0xff]*/
} ISP_FSWDR_MANUAL_ATTR_S;

typedef struct _ISP_FSWDR_AUTO_ATTR_S {
	CVI_U8 MergeMode[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0x1]*/
	...
	CVI_U8 WDRCombineMinWeight[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 WDRCombineMaxWeight[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 WDRCombineSNRAwareToleranceLevel[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
...
typedef struct _ISP_FSWDR_ATTR_S {
	...
	CVI_U8 TuningMode; /*RW; Range:[0x0, 0x3]*/
	ISP_OP_TYPE_E enOpType;
...
typedef struct _ISP_DRC_ATTR_S {
	CVI_BOOL Enable;
	CVI_U8 UpdateInterval; /*RW; Range:[0x1, 0xFF]*/
	CVI_U8 TuningMode; /*RW; Range:[0x0, 0x4]*/
	CVI_U8 ToneCurveSelect; /*RW; Range:[0x0, 0x1]*/
	CVI_U8 SdrToneCurveSelect; /*RW; Range:[0x0, 0x4]*/
...
#define ISP_CLUT_LUT_LENGTH 3276
typedef struct _ISP_CLUT_LUT_S {
	CVI_S16 Hlut[ISP_CLUT_LUT_LENGTH];
	CVI_S16 Slut[ISP_CLUT_LUT_LENGTH];
	CVI_S16 Vlut[ISP_CLUT_LUT_LENGTH];
} ISP_CLUT_LUT_S;
...
typedef struct _ISP_DIS_CONFIG_S {
	...
	CVI_U32 cropRatio; /*RW; Range:[0x0, 0x62] */
} ISP_DIS_CONFIG_S;
...
typedef struct _ISP_MOTION_INFO {
	CVI_U32 frameCnt;
	CVI_U8 gridWidth;
	CVI_U8 gridHeight;
	CVI_U8 *motionStsData;
