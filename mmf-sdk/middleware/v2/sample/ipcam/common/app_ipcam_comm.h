...
typedef enum APP_IPCAM_CMD_ID_E {
    ...
    CVI_CMD_OSD_SWITCH      = 1,
    CVI_CMD_COVER_SWITCH    = 2,
    CVI_CMD_RECT_SWITCH     = 3,
    CVI_CMD_AUDIO_SWITCH    = 4,
    CVI_CMD_AI_PD_SWITCH    = 5,
    CVI_CMD_AI_MD_SWITCH    = 6,
    CVI_CMD_AI_FD_SWITCH    = 7,
    CVI_CMD_AUTO_RGB_IR_SWITCH = 8,
    CVI_CMD_PQ_CAT          = 9,
    CVI_CMD_FLIP_SWITCH     = 10,
    CVI_CMD_MIRROR_SWITCH   = 11,
    CVI_CMD_180_SWITCH      = 12,
    CVI_CMD_ROTATE_SWITCH   = 13,
    CVI_CMD_RECORD_SET      = 14,
    CVI_CMD_MP3_PLAY        = 15,
    CVI_CMD_BUT
} APP_IPCAM_CMD_ID_T;
