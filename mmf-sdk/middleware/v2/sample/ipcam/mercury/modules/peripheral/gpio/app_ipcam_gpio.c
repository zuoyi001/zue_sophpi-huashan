...
/*************************************************
 *             IR-CUT switch control             *
 *************************************************/
void app_ipcam_IrCut_Switch(CVI_GPIO_NUM_E IR_CUT_A, CVI_GPIO_NUM_E IR_CUT_B, CVI_BOOL bSwitch)
{
    static CVI_BOOL bInit = CVI_FALSE;
...
/*************************************************
 *            SPEAKER mute pin switch            *
 *************************************************/
void app_ipcam_Speaker_Enable(CVI_GPIO_NUM_E SPEAKER_GPIO, CVI_BOOL bSwitch)
{
    static CVI_BOOL bInit = CVI_FALSE;

    if (!bInit) {
        app_ipcam_Gpio_Export(SPEAKER_GPIO);
        app_ipcam_Gpio_Dir_Set(SPEAKER_GPIO, CVI_GPIO_DIR_OUT);
        bInit = CVI_TRUE;
    }
    ...
    if (bSwitch) {
        ...
        app_ipcam_Gpio_Value_Set(SPEAKER_GPIO, CVI_GPIO_VALUE_L);
    }
}
