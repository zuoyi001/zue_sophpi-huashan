...
static int cvitek_pwm_set_config(struct udevice *dev, uint channel,
...
static int cvitek_pwm_set_enable(struct udevice *dev, uint channel,
				  bool enable)
{
	struct pwm_chip_priv *chip = dev_get_priv(dev);
	struct cvitek_pwm_regs *regs = (struct cvitek_pwm_regs *)chip->base;
...
static int cvitek_pwm_set_invert(struct udevice *dev, uint channel,
				  bool polarity)
{
	struct pwm_chip_priv *chip = dev_get_priv(dev);
	struct cvitek_pwm_regs *regs = (struct cvitek_pwm_regs *)chip->base;
