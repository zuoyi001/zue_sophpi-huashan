...
extern "C" {
     ...
     * @param[in]  postfilter_threshold     the interval [0, 1], face landmark postfilter threshold
     * @return     error code
     */
    FACE_API FaceRetCode set_detect_config(const float detect_threshold, const float postfilter_threshold);
    ...
    FACE_API FaceRetCode detect(const Image* const image, const float face_within_thr,  const int min_face_h, FaceHandle faceHandleArr[], int *length);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode detectAndTrack(const Image* const image, const float face_within_thr, const int min_face_h, FaceHandle faceHandleArr[], int *length);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode refineLandmark(const Image* const image, FaceHandle handle, Landmark *result);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode getPoseBlurAttribute(const Image* const image, FaceHandle handle, FacePoseBlur* result);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode getFaceAttrResult(const Image* const image, FaceHandle handle, FaceAttr *result);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode getFaceOcclResult(const Image* const image, FaceHandle handle, FaceOccl *result);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode extract(const Image* const image, FaceHandle handle, char** feature_result, int *size);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode compare(const char* const first_feature, const char* const second_feature, const int feature_length, float *result);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode getLiveness_bgr(const Image* const image, FaceHandle handle, float *liveness_result);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode getLiveness_ir(const Image* const image, FaceHandle handle, float *liveness_result);
     ...
     * @param[in]  y_k
     * @param[in]  y_b
     * @param[in]  overlap_rate  the interval [0.1, 0.9], the overlap rate threshold for ir detect rect and bgr detect rect,
     default 0.4, if two rects overlap_rate is larger than threshold, they are in pairs.
     * @return     error code
     */
    FACE_API FaceRetCode set_match_config(const float x_k, const float x_b, const float y_k, const float y_b, const float overlap_rate);
     ...
     * @param[out] pair             record ir face index corresponding to every visible light face, match pair: i->pair[i], or if pair[i] == ir_length is attack;
     * @return     error code
     */
    FACE_API FaceRetCode BGR_IR_match(FaceHandle* bgr_handle_array, const int length, FaceHandle* ir_handle_array, const int ir_length, int *pair);
     ...
     * @param[out] filter_result    pointer to the result, 1 pass ir_filter, 0 failed ir_filter
     * @return     error code
     */
    FACE_API FaceRetCode ir_filter(FaceHandle * bgr_handle_array, const int length, FaceHandle* ir_handle_array, const int ir_length, char *filter_result);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode getLiveness_bgrir(const Image* const bgr_image, FaceHandle bgr_handle, const Image* const ir_image, FaceHandle ir_handle, float *liveness_result);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode identifyFromFaceGroup(FaceGroupHandle handle, const char* const target, const int feature_length, float *result, uint64_t *idx);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode top_k_FromFaceGroup(FaceGroupHandle handle, const char *target, const int feature_length, const int k, float *result, uint64_t *idx);
