...
CVI_S32 APP_SetVpssConfig(VPSS_GRP VpssGrp,VPSS_GRP_ATTR_S* stVpssGrpAttr)
{
	...
	if(VpssGrp == 0)
	{
		...
		VpssChn        = VPSS_CHN2;
		astVpssChnAttr[VpssChn].u32Width                    = 854;
		...
		astVpssChnAttr[VpssChn].stAspectRatio.stVideoRect.s32X = 584;
		astVpssChnAttr[VpssChn].stAspectRatio.stVideoRect.s32Y = 0;
		astVpssChnAttr[VpssChn].stAspectRatio.stVideoRect.u32Width = 270;
		astVpssChnAttr[VpssChn].stAspectRatio.stVideoRect.u32Height = 480;
		astVpssChnAttr[VpssChn].stAspectRatio.bEnableBgColor= CVI_TRUE;
		astVpssChnAttr[VpssChn].stAspectRatio.u32BgColor  	= COLOR_RGB_BLACK;
	}
	else if(VpssGrp == 1)
...
CVI_S32 APP_InitVpss(void)
{
	...
	APP_SetVpssAspect(2,0,0,720,1280);
