...
#define LV_HOR_RES_MAX          CONFIG_PANEL_DISPLAY_HOR
#define LV_VER_RES_MAX          CONFIG_PANEL_DISPLAY_VER
...
#define LV_THEME_DEFAULT_INIT               lv_theme_ag_init
