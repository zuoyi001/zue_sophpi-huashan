...
void fbdev_flush(lv_disp_drv_t * drv, const lv_area_t * area, lv_color_t * color_p)
{
    ...
    /*16 bit per pixel*/
        ...
        for(y = act_y1; y <= act_y2; y++) {
            ...
            //printf("zhxjun location:%d color_p:%p size:%d\n",location,color_p,(act_x2 - act_x1 + 1) * 2);
...
void lvgl_init(char* rgn_fbp)
{
    ...
    vinfo.yres_virtual = LV_VER_RES_MAX;
    vinfo.bits_per_pixel = 32;
    finfo.line_length = 2880;
    printf("set fbp as rgn addr:%p\n",rgn_fbp);
}
