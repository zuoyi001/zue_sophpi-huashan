...
#define COLOR_SCR        (IS_LIGHT ? lv_color_hex(0x1E90FF) : lv_color_hex(0x444b5a))
#define COLOR_SCR_TEXT   (IS_LIGHT ? lv_color_hex(0xFFFAFA) : lv_color_hex(0xe7e9ec))
...
//(theme.flags & LV_THEME_MATERIAL_FLAG_LIGHT)
...
static void basic_init(void)
{
    ...
    lv_style_set_pad_left(&styles->bg, LV_STATE_DEFAULT, 0);//PAD_DEF + BORDER_WIDTH);
    lv_style_set_pad_right(&styles->bg, LV_STATE_DEFAULT, 0);//PAD_DEF + BORDER_WIDTH);
    lv_style_set_pad_top(&styles->bg, LV_STATE_DEFAULT, 0); //PAD_DEF + BORDER_WIDTH);
    lv_style_set_pad_bottom(&styles->bg, LV_STATE_DEFAULT, 0); //PAD_DEF + BORDER_WIDTH);
    lv_style_set_pad_inner(&styles->bg, LV_STATE_DEFAULT, 0);// PAD_DEF);
    ...
    lv_style_set_bg_color(&styles->btn, LV_STATE_PRESSED, COLOR_BTN);
    lv_style_set_bg_color(&styles->btn, LV_STATE_CHECKED, COLOR_BTN);
    lv_style_set_bg_color(&styles->btn, LV_STATE_CHECKED | LV_STATE_PRESSED, COLOR_BTN);
    lv_style_set_bg_color(&styles->btn, LV_STATE_DISABLED, COLOR_BTN);
    lv_style_set_bg_color(&styles->btn, LV_STATE_DISABLED | LV_STATE_CHECKED, COLOR_BTN);
    lv_style_set_border_color(&styles->btn, LV_STATE_DEFAULT, COLOR_BTN);
    lv_style_set_border_color(&styles->btn, LV_STATE_PRESSED, COLOR_BTN);
    lv_style_set_border_color(&styles->btn, LV_STATE_DISABLED, COLOR_BTN);
    ...
    lv_style_set_outline_width(&styles->btn, LV_STATE_DEFAULT, 1);
    ...
    lv_style_set_outline_color(&styles->btn, LV_STATE_DEFAULT, COLOR_BTN);
    lv_style_set_outline_color(&styles->btn, LV_STATE_EDITED, COLOR_BTN);
...
static void list_init(void)
{
    ...
    lv_style_set_clip_corner(&styles->list_bg, LV_STATE_DEFAULT, false);
    lv_style_set_pad_left(&styles->list_bg, LV_STATE_DEFAULT, 20);
    lv_style_set_pad_right(&styles->list_bg, LV_STATE_DEFAULT, 20);
    ...
    lv_style_set_bg_color(&styles->list_btn, LV_STATE_PRESSED, COLOR_BG);
    lv_style_set_bg_color(&styles->list_btn, LV_STATE_DISABLED, COLOR_BG);
    lv_style_set_bg_color(&styles->list_btn, LV_STATE_CHECKED, COLOR_BG);
    lv_style_set_bg_color(&styles->list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, COLOR_BG);
    ...
    lv_style_set_border_color(&styles->list_btn, LV_STATE_DEFAULT, LV_COLOR_GRAY);
    lv_style_set_border_color(&styles->list_btn, LV_STATE_FOCUSED, LV_COLOR_GRAY);
    lv_style_set_border_width(&styles->list_btn, LV_STATE_DEFAULT, 1);
    lv_style_set_border_opa(&styles->list_btn, LV_STATE_DEFAULT, LV_OPA_60);
    lv_style_set_border_opa(&styles->list_btn, LV_STATE_FOCUSED, LV_OPA_60);

    lv_style_set_outline_color(&styles->list_btn, LV_STATE_FOCUSED, theme.color_secondary);
    lv_style_set_outline_width(&styles->list_btn, LV_STATE_FOCUSED, 0);
    lv_style_set_outline_pad(&styles->list_btn, LV_STATE_FOCUSED, 0);
    ...
    lv_style_set_transform_width(&styles->list_btn, LV_STATE_DEFAULT, 0);
    ...
    lv_style_set_transform_width(&styles->list_btn, LV_STATE_FOCUSED, 0);
 ...
 */
lv_theme_t * lv_theme_ag_init(lv_color_t color_primary, lv_color_t color_secondary, uint32_t flags,
