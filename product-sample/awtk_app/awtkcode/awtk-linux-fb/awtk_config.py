...
#for prebuild tslib
# commented by garry.xin,20200810
...
#for pc build
# revised by garry.xin,20200810
SDK_PATH = os.environ['SDK_PATH'] 
TOOLS_PREFIX = SDK_PATH + '/riscv64-unknown-linux-musl-'
TSLIB_LIB_DIR=''
...
COMMON_CCFLAGS = COMMON_CCFLAGS + ' -DWITH_LCD_CLEAR_ALPHA=1 '
...
STATIC_LIBS =['awtk_global', 'extwidgets', 'widgets',  'base', 'gpinyin', 'streams', 'conf_io', 'compressors', 'miniz', 'ubjson', 'tkc', 'nanovg-agge', 'agge', 'nanovg', 'linebreak'] + OS_LIBS
if TSLIB_LIB_DIR != '':
...
OS_WHOLE_ARCHIVE =' -Wl,--whole-archive -lawtk_global -lextwidgets -lwidgets -lbase -lgpinyin -ltkc -lstreams -lconf_io -lubjson -lcompressors -lminiz -llinebreak -Wl,--no-whole-archive'
